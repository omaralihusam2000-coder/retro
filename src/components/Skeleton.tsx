export function DealCardSkeleton() {
  return (
    <div className="flex flex-col overflow-hidden rounded-xl border border-ink-700 bg-ink-800">
      ...
      <div className="flex flex-col gap-2 p-3.5">
        ...
        <div className="mt-1 h-8 w-full animate-pulse rounded-lg bg-ink-700/40" />
      </div>
    </div>
  );
}
