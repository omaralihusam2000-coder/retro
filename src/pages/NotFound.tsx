...
export default function NotFound() {
  return (
    <div className="mx-auto flex max-w-lg flex-col items-center px-4 py-32 text-center">
      <Gamepad2 size={40} className="mb-4 text-neon-500" />
      ...
      <Link
        to="/"
        className="mt-6 rounded-full bg-neon-500 px-5 py-2.5 font-display text-sm font-bold text-ink-950 hover:bg-neon-400"
      >
        Back to home
      </Link>
    </div>
