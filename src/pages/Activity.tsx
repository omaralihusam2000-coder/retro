...
export default function Activity() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-neon-500">Community</p>
      ...
      <div className="mt-8 rounded-xl border border-ink-800 bg-ink-900/40 px-4">
